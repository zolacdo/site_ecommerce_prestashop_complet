        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-orange-300 text-sm font-medium">Formation #1 en France</span>
            </div>
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Formations expertes, modules premium et thèmes professionnels pour propulser votre boutique e-commerce vers le succès.
            </p>
          ...
          <div className="relative">
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <img
                ...
                alt="Formation PrestaShop"
                className="w-full h-80 object-cover rounded-lg mb-6"
              />
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-orange-300 font-medium">Formation du moment</span>
                  <div className="flex items-center">
                    <Star className="h-4 w-4 text-orange-400 fill-current" />
                    <span className="ml-1 text-sm">4.9 (247 avis)</span>
                  </div>
                </div>
                <h3 className="text-xl font-bold">Formation PrestaShop Complète</h3>
                <p className="text-blue-100 text-sm">De débutant à expert en 25 heures</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <span className="text-2xl font-bold text-orange-400">199€</span>
                    <span className="text-gray-400 line-through">299€</span>
                  </div>
                  <span className="bg-red-500 text-white px-2 py-1 rounded text-xs font-medium">-33%</span>
                </div>
              </div>
            </div>
          </div>
